...
[_COLEMAK] = LAYOUT_planck_grid(
  ...
  KC_ESC,  KC_AT,   KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_SPC,  RAISE,   TREX,    KC_LEFT, KC_DOWN, KC_RIGHT  \
),
 ...
 * |      |  4   |  5   |  6   |   !  |      |      |   _  |   +  |   {  |   }  |  |   |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |  1   |  2   |  3   |   #  |      |      | PgUp | PgDn |      |  ?   |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |  .   |  0   |      |      |      |      |      |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT_planck_grid(
  KC_TILD,   KC_KP_7, KC_KP_8, KC_KP_9, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL,  \
  _______,   KC_KP_4, KC_KP_5, KC_KP_6, KC_EXLM, _______, _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
  _______,   KC_KP_1, KC_KP_2, KC_KP_3, KC_HASH, _______, _______, KC_PGUP, KC_PGDN, _______, KC_QUES,  KC_ENT, \
  KC_KP_DOT, KC_KP_0, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ \
),
...
[_RAISE] = LAYOUT_planck_grid(
  ...
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_LABK, KC_RABK, _______, KC_SLSH, KC_ENT, \
...
[_ADJUST] = LAYOUT_planck_grid(
  ...
  _______, _______, _______, _______, _______, _______, _______, KC_CAPSLOCK, KC_SCROLLLOCK, KC_NUMLOCK, _______, _______,  \
